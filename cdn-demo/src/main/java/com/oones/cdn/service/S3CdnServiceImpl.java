...
@Service("s3CdnService")
public class S3CdnServiceImpl implements CdnService<Blob> {

	private static final Logger LOG = LoggerFactory.getLogger(S3CdnServiceImpl.class);
